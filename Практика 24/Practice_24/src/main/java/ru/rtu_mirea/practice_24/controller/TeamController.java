...
import ru.rtu_mirea.practice_24.service.TeamService;
...
public class TeamController {
    ...
    public ResponseEntity<List<Team>> findTeamByCreationDate(@PathVariable(name="creationDate") String creationDate) {
